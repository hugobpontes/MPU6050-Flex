...
uint8_t AccCalibData3[6] = {0x01,0x00,0x03,0x00,0x5F,0x01}; //3rd set of readings
uint8_t AccCalibData4[6] = {0x02,0x00,0x04,0x00,0x5F,0x01}; //4th set of readings

uint8_t GyroCalibData1[6] = {0x07,0x00,0x00,0x00,0x0E,0x05}; //1st set of readings
uint8_t GyroCalibData2[6] = {0x08,0x00,0x01,0x00,0x0E,0x05}; //2nd set of readings
